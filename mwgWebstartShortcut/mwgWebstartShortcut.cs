...
namespace mwgWebstartShortcut
{
    public partial class mwgWebstartShortcut : Form
    {
        ...
        {
            //set mwgIP varialbe as the IP entered by user
            mwgIP = textBoxIP.Text;

            //build webstart.jnlp with entered IP from user
            ...
            //start new process that start cmd.exe and performs javaws + filepath command
